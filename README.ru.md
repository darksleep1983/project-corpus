...
Репозиторий находится на этапе private preview и активной проверки. Паритет
русского и английского шаблонов, три режима доступа, ссылки документации и
целостность репозитория проверяются автоматически. Public и release требуют
